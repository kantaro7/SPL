...
{
   public class FPCTestsGeneralDto
    {
        ...
        [DataType(DataType.Text)]
        [MaxLength(10, ErrorMessage = "El campo Especificación solo puede tener {0} caracteres")]
        public string Specification { get; set; }

        [Range(0, 999999, ErrorMessage = "El campo Frecuencia debe ser numérico mayor a cero considerando hasta 6 enteros")]
        ...
        public List<FPCTestsDto> Data { get; set; }
    }
}