...
namespace SPL.Reports.Api.DTOs.Reports.PIM
{
   public class PIMTestsGeneralDto
    {
        ...
        [DataType(DataType.Text)]
        [MaxLength(2, ErrorMessage = "El campo Aplica Baja solo puede tener {0} caracteres")]
        public string ApplyLow { get; set; }

        //[DataType(DataType.Text)]
        //[MaxLength(5, ErrorMessage = "El campo Nivel Tensión solo puede tener {0} caracteres")]
        ...
        public List<PIMTestsDetailsDto> Data { get; set; }
    }
}
