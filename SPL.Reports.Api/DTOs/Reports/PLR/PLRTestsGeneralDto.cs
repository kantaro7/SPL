...
{
   public class PLRTestsGeneralDto
    {
        ...
        [Range(0, 99, ErrorMessage = "El campo Cantidad de Tensiones debe ser numérico mayor a cero considerando hasta 2 enteros")]
        public int AmountOfTensions { get; set; }

        [Range(0, 99, ErrorMessage = "El campo Cantidad de Tiempo debe ser numérico mayor a cero considerando hasta 2 enteros")]
        ...
        public PLRTestsDto Data { get; set; }
    }
}
