...
namespace SPL.Reports.Api.DTOs.Reports { 
    public class RANReportDto
    {
        ...
        [Range(0, 99, ErrorMessage = "El campo Cantidad de Mediciones debe ser numérico mayor a cero considerando hasta 2 enteros")]
        ...
        public List<RANReportDetailsDto> Rans { get; set; }
    }
}
