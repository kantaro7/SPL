...
namespace SIDCO.Domain.Domain.Models
{
    public class GeneralArtifact
    {
        ...
        public GeneralArtifact(string orderCode, string descripcion, decimal? phases, 
            string customerName, decimal? frecuency, string poNumeric, decimal? altitudeF1,
            string altitudeF2, decimal? typetrafoid, string tipoUnidad, decimal? applicationid, 
            decimal? standardid, string norma, decimal? languageId, string claveIdioma, decimal? polarityId, 
            string polarityOther, string desplazamientoAngular, string creadopor, DateTime fechacreacion,
