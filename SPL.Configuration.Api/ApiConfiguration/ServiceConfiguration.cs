namespace SPL.Configuration.Api.ApiConfiguration
{
    ...
    using SPL.Configuration.Api.AutoMapper;
    using SPL.Configuration.Infrastructure.Configuration;
    ...
    public static class ServiceConfiguration
    {
        ...
        internal static void ConfigureDependencies(this IServiceCollection services)
        {
            ...
            //Infrastructure
            _ = services.AddTransient<IConfigurationInfrastructure, ConfigurationInfrastructure>();
            _ = services.AddAutoMapper(typeof(ConfigurationProfile).Assembly);
        }
