namespace SPL.Domain.SPL.Tests.PCI
{
    using System.Collections.Generic;

    public class PCITestResponse
    {
    ...
    public class RatingPCITestResult
    {
        #region Properties
        ...
        public List<SecondaryPositionPCITestResult> SecondaryPositions { get; set; } = new List<SecondaryPositionPCITestResult>();

        #endregion
    }

    public class SecondaryPositionPCITestResult
    {
        #region Properties
