...
{
    public partial class dbReportsSPLContext : DbContext
    {
        public dbReportsSPLContext()
        {
        }

        public dbReportsSPLContext(DbContextOptions<dbReportsSPLContext> options)
            : base(options)
        {
        }
        ...
        public virtual DbSet<SplConfigArchivo> SplConfigArchivos { get; set; }
        ...
        public virtual DbSet<SplDatossecEst> SplDatossecEsts { get; set; }
        ...
        public virtual DbSet<SplInfoSeccionIsz> SplInfoSeccionIszs { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<SplConfigArchivo>(entity =>
            {
                entity.HasKey(e => new { e.Proceso, e.Hoja, e.Orden });

                entity.ToTable("SPL_CONFIG_ARCHIVO");
                ...
                entity.Property(e => e.FinDato)
                    .HasMaxLength(10)
                    .IsUnicode(false)
                    .HasColumnName("FIN_DATO");

                entity.Property(e => e.FinEtiqueta)
                    .HasMaxLength(10)
                    .IsUnicode(false)
                    .HasColumnName("FIN_ETIQUETA");
                ...
                entity.Property(e => e.IniDato)
                    .HasMaxLength(10)
                    .IsUnicode(false)
                    .HasColumnName("INI_DATO");

                entity.Property(e => e.IniEtiqueta)
                    .HasMaxLength(10)
                    .IsUnicode(false)
                    .HasColumnName("INI_ETIQUETA");
                ...
                entity.Property(e => e.Tabla1)
                    .HasMaxLength(50)
                    .IsUnicode(false)
                    .HasColumnName("TABLA_1");

                entity.Property(e => e.Tabla2)
                    .HasMaxLength(50)
                    .IsUnicode(false)
                    .HasColumnName("TABLA_2");
            ...
            {
                entity.HasKey(e => new { e.IdCorte, e.Seccion, e.Renglon });
            ...
            modelBuilder.Entity<SplCortegralEst>(entity =>
            {
                ...
                entity.Property(e => e.TipoRegresion).HasColumnName("TIPO_REGRESION");
            ...
            {
                entity.HasKey(e => new { e.IdCorte, e.Seccion });
                ...
                entity.Property(e => e.ValorB)
                    .HasColumnType("numeric(11, 5)")
                    .HasColumnName("VALOR_B");

                entity.Property(e => e.ValorC)
                    .HasColumnType("numeric(24, 18)")
                    .HasColumnName("VALOR_C");
            ...
            {
                entity.HasKey(e => new { e.IdReg, e.FechaHora });
                ...
                entity.Property(e => e.VerifMotobom)
                    .HasMaxLength(50)
                    .IsUnicode(false)
                    .HasColumnName("VERIF_MOTOBOM");

                entity.Property(e => e.VerifVentilador)
                    .HasMaxLength(50)
                    .IsUnicode(false)
                    .HasColumnName("VERIF_VENTILADOR");
            });
            ...
            modelBuilder.Entity<SplDatosgralEst>(entity =>
            {
                ...
                entity.Property(e => e.BtDifCap).HasColumnName("BT_DIF_CAP");
                ...
                entity.Property(e => e.TerBt2)
                    .IsRequired()
                    .HasMaxLength(10)
                    .IsUnicode(false)
                    .HasColumnName("TER_BT2");

                entity.Property(e => e.TerCapRed).HasColumnName("TER_CAP_RED");
            ...
            modelBuilder.Entity<SplDatossecEst>(entity =>
            {
                entity.HasKey(e => new { e.IdReg, e.Seccion });

                entity.ToTable("SPL_DATOSSEC_EST");
            ...
            {
                entity.HasKey(e => e.CoolingType)
                    .HasName("PK_SPL_FACTORCOR_ETD_1");
            ...
            {
                entity.HasKey(e => new { e.IdRep, e.Orden });
            ...
            {
                entity.HasKey(e => new { e.IdRep, e.Renglon, e.IdSeccion });
            ...
            modelBuilder.Entity<SplInfoGeneralEtd>(entity =>
            {
                ...
                entity.Property(e => e.CorrXKw).HasColumnName("CORR_X_KW");
                ...
                entity.Property(e => e.FactorAlt)
                    .HasColumnType("numeric(5, 2)")
                    .HasColumnName("FACTOR_ALT");
            ...
            modelBuilder.Entity<SplInfoGraficaEtd>(entity =>
            {
                ...
                entity.Property(e => e.ValorZ)
                    .HasColumnType("numeric(7, 4)")
                    .HasColumnName("VALOR_Z");
            });
            ...
            modelBuilder.Entity<SplInfoSeccionIsz>(entity =>
            {
                entity.HasKey(e => new { e.IdRep, e.IdSeccion });

                entity.ToTable("SPL_INFO_SECCION_ISZ");
                ...
                entity.Property(e => e.ImpedanciaGar)
                    .HasColumnType("numeric(9, 3)")
            ...
            {
                entity.HasKey(e => new { e.NoSerie, e.CoolingType });
                ...
                entity.Property(e => e.BtBt1)
                    .HasColumnType("numeric(7, 4)")
                    .HasColumnName("BT_BT1");
                ...
                entity.Property(e => e.KwFeMedido)
                    .HasColumnType("numeric(7, 4)")
                    .HasColumnName("KW_FE_MEDIDO");
