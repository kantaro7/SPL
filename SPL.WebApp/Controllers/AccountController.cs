namespace SPL.WebApp.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(IOptionsMonitor<MicrosoftIdentityOptions> microsoftIdentityOptionsMonitor) => _optionsMonitor = microsoftIdentityOptionsMonitor;
            ...
            [FromQuery] string scheme)
        {
            ...
            string callbackUrl = Url.Action("Index", "Home", values: null, protocol: Request.Scheme);
