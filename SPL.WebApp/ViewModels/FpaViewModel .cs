namespace SPL.WebApp.ViewModels
{
    ...
    public class FpaViewModel
    {
        public FpaViewModel() => this.TreeViewItem = new List<TreeViewItemDTO>();
        ...
        public SettingsToDisplayFPAReportsDTO FPAReportsDTO { get; set; }

        public bool IsReportAproved { get; set; }

        public string Base64PDF { get; set; }

        public FPATestsDTO FPATestsDTO { get; set; }
        public string Error { get; set; }

        public bool IncluirSegundaFila { get; set; }
    }
}
