namespace SPL.WebApp.ViewModels
{
    ...
    public class BpcViewModel
    {
        public BpcViewModel() => this.TreeViewItem = new List<TreeViewItemDTO>();
        ...
        public SettingsToDisplayBPCReportsDTO BPCReportsDTO { get; set; }
        public bool IsReportAproved { get; set; }
        public string Base64PDF { get; set; }
        public string Error { get; set; }
        public BPCTestsGeneralDTO BPCTestsGeneralDTO { get; set; }
    }
}
