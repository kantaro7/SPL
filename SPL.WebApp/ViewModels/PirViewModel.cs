namespace SPL.WebApp.ViewModels
{
    ...
    {
        public PirViewModel() => this.TreeViewItem = new List<TreeViewItemDTO>();
        ...
        public SettingsToDisplayPIRReportsDTO SettingsPIR { get; set; }
        ...
        public List<PirPruebasDTO> PirPruebasDTO { get; set; }

        public List<string> NivelesdeTensiones { get; set; }

        public int Contador { get; set; }

        public List<ArchivosFrontViewModel> Archivos { get; set; }
        public List<string> Archivos2 { get; set; }

        public List<string> Archivos3 { get; set; }
