namespace SPL.WebApp.ViewModels
{
    ...
    public class TdpViewModel
    {
        public TdpViewModel() => this.TreeViewItem = new List<TreeViewItemDTO>();
        ...
        [RegularExpression(@"^(([0-9]{0,3})|([0-9]{0,3}\.[0-9]{1,3}))$", ErrorMessage = "El nivel de la hora es numérico mayor a cero considerando 3 enteros con 3 decimales")]
        ...
        [RegularExpression(@"^(([0-9]{0,3})|([0-9]{0,3}\.[0-9]{1,3}))$", ErrorMessage = "El nivel del realce numérico mayor a cero considerando 3 enteros con 3 decimales")]
        ...
        public SettingsToDisplayTDPReportsDTO SettingsTDP { get; set; }
