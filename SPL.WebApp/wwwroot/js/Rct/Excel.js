...
btnSave.addEventListener("click", function () {
    if (!save) {
        ...
        LoadWorkbook();
        postData(domain + "/Rct/SavePDF/", viewModel)
            .then(data => {
...
btnValidate.addEventListener("click", function () {
    LoadWorkbook();
    $("#loader").css("display", "block");
    postData(domain + "/Rct/Validate/", viewModel)
        .then(data => {
...
function SetDataSourceSpredsheet(workbook) {
    spreadsheetElementRCT.data("kendoSpreadsheet").destroy()
    $("#spreadsheet").empty();
    SetConfigExcel(workbook);
}
...
function SetConfigExcel(workbook) {
    ...
    spreadsheetElementRCT = $("#spreadsheet").kendoSpreadsheet({
