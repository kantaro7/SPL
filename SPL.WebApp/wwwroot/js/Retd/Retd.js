...
btnStart.addEventListener("click", function () {
    ...
    if (posAt.value !== "" && posBt.value !== "") {
    } else if (posAt.value !== "" && posTer.value !== "") {
    } else if (posBt.value !== "" && posTer.value !== "") {
    } else {
        ShowFailedMessage("Debe seleccionar dos posiciones para continuar con el proceso");
        return;
    }
...
btnClear1.addEventListener("click", function () {
    fechaDatos.value = ''
    coolingType.value = ""
    coolingType.disabled = true
    posAt.disabled = true
    posBt.disabled = true
    posTer.disabled = true
    porcCarga.disabled = true
    cantTermoPares.disabled = true
    corriente.disabled =true
    perdidas.disabled = true
    devanadoSplit.disabled = true
    ...
    factAlt.value =''
    porcCarga.value =''
    cantTermoPares.value = ''
    perdidas.value ='Pérdidas'
    overElevation.value =''
    intervalo.value ='1'
    devanadoSplit.value ='NA'
    capacidad.value = ''
    corriente.value = ''
    ...
    $("#SecondTable thead").empty()

    let thead = `<tr>  <th id="thora">HORA: </th>   <th id="tcanal">Canal </th>`;
    for (var i = 0; i < 52; i++) {
        thead = thead  +'<th id="thora_"'+i+'>00:00 </th>'
    }
    thead = thead + '</tr>'
    $("#SecondTable thead").append(thead);
...
// Convierte la fecha del datepicker a una de C#
function ConvertDate(cadena) {
    let dateTime = cadena.split(', ');
...
function LoadSelectETD(nuevo) {
    if (nuevo) {
        selectETD = viewModel.Nuevo;
        selectETD.NoSerie = noSerieInput.value;
    }

    selectETD.FechaDatos = ConvertDate(fechaDatos.value);
...
function LoadSelectETDDetails(nuevo) {
    if (nuevo) {
        ...
        selectETD.StabilizationDataDetails.KwMedidos = []
        selectETD.StabilizationDataDetails.AmpMedidos = []
        selectETD.StabilizationDataDetails.KwMedidos = []
        selectETD.StabilizationDataDetails.CabSupRadBco1 = []
        selectETD.StabilizationDataDetails.CabSupRadBco2 = []
        selectETD.StabilizationDataDetails.CabSupRadBco3 = []
        selectETD.StabilizationDataDetails.CabSupRadBco4 = []
        selectETD.StabilizationDataDetails.CabSupRadBco5 = []
        selectETD.StabilizationDataDetails.CabSupRadBco6 = []
        selectETD.StabilizationDataDetails.CabSupRadBco7 = []
        selectETD.StabilizationDataDetails.CabSupRadBco8 = []
        selectETD.StabilizationDataDetails.CabSupRadBco9 = []
        selectETD.StabilizationDataDetails.CabSupRadBco10 = []
        selectETD.StabilizationDataDetails.CanalInf1;
        selectETD.StabilizationDataDetails.CanalInf2;
        selectETD.StabilizationDataDetails.CanalInf3;
        selectETD.StabilizationDataDetails.CanalInf4;
        selectETD.StabilizationDataDetails.CanalInf5;
        selectETD.StabilizationDataDetails.CanalInf6;
        selectETD.StabilizationDataDetails.CanalInf7;
        selectETD.StabilizationDataDetails.CanalInf8;
        selectETD.StabilizationDataDetails.CanalInf9;
        selectETD.StabilizationDataDetails.CanalInf10;

        selectETD.StabilizationDataDetails.CabInfRadBco1 = []
        selectETD.StabilizationDataDetails.CabInfRadBco2 = []
        selectETD.StabilizationDataDetails.CabInfRadBco3 = []
        selectETD.StabilizationDataDetails.CabInfRadBco4 = []
        selectETD.StabilizationDataDetails.CabInfRadBco5 = []
        selectETD.StabilizationDataDetails.CabInfRadBco6 = []
        selectETD.StabilizationDataDetails.CabInfRadBco7 = []
        selectETD.StabilizationDataDetails.CabInfRadBco8 = []
        selectETD.StabilizationDataDetails.CabInfRadBco9 = []
        selectETD.StabilizationDataDetails.CabInfRadBco10 = []


        selectETD.StabilizationDataDetails.PromRadInf = []

        selectETD.StabilizationDataDetails.CanalAmb1;
        selectETD.StabilizationDataDetails.CanalAmb2;
        selectETD.StabilizationDataDetails.CanalAmb3;

        selectETD.StabilizationDataDetails.Ambiente1 = []
        selectETD.StabilizationDataDetails.Ambiente2 = []
        selectETD.StabilizationDataDetails.Ambiente3 = []

        selectETD.StabilizationDataDetails.AmbienteProm= [];
        selectETD.StabilizationDataDetails.CanalTtapa;



        selectETD.StabilizationDataDetails.TempTapa = []
        selectETD.StabilizationDataDetails.Aor = []
        selectETD.StabilizationDataDetails.Tor = []
        selectETD.StabilizationDataDetails.Bor = []
        selectETD.StabilizationDataDetails.AorCorr = []
        selectETD.StabilizationDataDetails.TorCorr = []


        selectETD.StabilizationDataDetails.TempInstr1 = []
        selectETD.StabilizationDataDetails.TempInstr2 = []
        selectETD.StabilizationDataDetails.TempInstr3 = []

        selectETD.StabilizationDataDetails.CanalInst1;
        selectETD.StabilizationDataDetails.CanalInst2;
        selectETD.StabilizationDataDetails.CanalInst3;

        selectETD.StabilizationDataDetails.VerifVent1 = []
        selectETD.StabilizationDataDetails.VerifVent2 = []
        selectETD.StabilizationDataDetails.PromRadSup = []

        selectETD.StabilizationDataDetails.Presion = []
    }
    ...
    pos++;
    //preguntar si esto es un arreglo o un string
    selectETD.StabilizationDataDetails.AmbienteProm.push (($('#inputcanal_' + pos).val() != '') ? +$('#inputcanal_' + pos).val() : null);
    pos++;
...
function LoadSecundaryTable(data) {
    ...
    // renglones
    let filaNum = 0;
    let content = AddSecundaryRow(data.StabilizationDataDetails.KwMedidos, filaNum, null , 'kW Medidos');
    filaNum++;
    content += AddSecundaryRow(data.StabilizationDataDetails.AmpMedidos, filaNum, null, 'Amp. Medidos');
    filaNum++;
    ...
    content += AddSecundaryRow(data.StabilizationDataDetails.PromRadSup, filaNum, null, 'PROMEDIO Rad. Sup.', true);
    filaNum++;
    ...
    content += AddSecundaryRow(data.StabilizationDataDetails.PromRadInf, filaNum, null, 'PROMEDIO Rad. Inf.', true);
    filaNum++;
    ...
    content += AddSecundaryRow(data.StabilizationDataDetails.AmbienteProm, filaNum, null, 'Ambiente PROMEDIO', true);
    filaNum++;
    ...
    content += AddSecundaryRow(data.StabilizationDataDetails.Aor, filaNum, null, 'Elevación del  Aceite  Promedio (AOR)', true);
    filaNum++;

    content += AddSecundaryRow(data.StabilizationDataDetails.Tor, filaNum, null, 'Elevación del  Aceite  Superior  (TOR)', true);
    filaNum++;

    content += AddSecundaryRow(data.StabilizationDataDetails.Bor, filaNum, null, 'Elevación del aceite Inferior (BOR)', true);
    filaNum++;

    content += AddSecundaryRow(data.StabilizationDataDetails.AorCorr, filaNum, null, 'AOR cor. x Altitud a ' + data.AltitudeF1 + ' ' + data.AltitudeF2, true);
    filaNum++;

    content += AddSecundaryRow(data.StabilizationDataDetails.TorCorr, filaNum, null, 'TOR cor. x Altitud a ' + data.AltitudeF1 + ' ' + data.AltitudeF2, true);
    filaNum++;
    ...
    content += AddSecundaryRow(data.StabilizationDataDetails.VerifVent1, filaNum, null, 'Verificación de motobombas (flujo, funcionamiento, etc)', false, true);
    filaNum++;

    content += AddSecundaryRow(data.StabilizationDataDetails.VerifVent2, filaNum, null, 'Verificación de motobombas (flujo, funcionamiento, etc)', false, true);
    filaNum++;

    content += AddSecundaryRow(data.StabilizationDataDetails.Presion, filaNum, null, 'Presión');
