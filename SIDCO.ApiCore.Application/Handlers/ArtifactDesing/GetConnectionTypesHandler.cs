...
{
    public class GetConnectionTypesHandler : IRequestHandler<GetConnectionTypesQuery, List<GeneralProperties>>
    {
        ...
        #region Methods
        public async Task<List<GeneralProperties>> Handle(GetConnectionTypesQuery request, CancellationToken cancellationToken)
        {
            return await _infrastructure.GetConnectionTypes();
