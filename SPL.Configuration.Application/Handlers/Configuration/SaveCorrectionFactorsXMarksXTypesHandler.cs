namespace SPL.Configuration.Application.Handlers.Configuration
{
    ...
    public class SaveCorrectionFactorsXMarksXTypesHandler : IRequestHandler<SaveCorrectionFactorsXMarksXTypesCommand, ApiResponse<long>>
    {

        private readonly IConfigurationInfrastructure _infrastructure;

        public SaveCorrectionFactorsXMarksXTypesHandler(IConfigurationInfrastructure infrastructure) => this._infrastructure = infrastructure;

        #region Methods
        public async Task<ApiResponse<long>> Handle(SaveCorrectionFactorsXMarksXTypesCommand request, CancellationToken cancellationToken)
        {
            try
            {
                ...
                var result = await _infrastructure.saveCorrectionFactorsXMarksXTypes(request.Data);
