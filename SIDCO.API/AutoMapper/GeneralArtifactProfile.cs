...
namespace SIDCO.API.AutoMapper
{
    public class GeneralArtifactProfile : Profile
    {
        public GeneralArtifactProfile()
        {
            ...
            _ = CreateMap<CoreCatalog, GeneralProperties>().ReverseMap();
           ...
           .ForMember(dest => dest.PorcentajeSupSc, act => act.MapFrom(src => src.PorcentajeSupSc)).ReverseMap();
            ...
            CreateMap<Derivations, DerivationsDto>()
             ...
             .ForMember(dest => dest.IdConexionEquivalente2, act => act.MapFrom(src => src.conexionequivalente_2))
             .ForMember(dest => dest.IdConexionEquivalente3, act => act.MapFrom(src => src.conexionequivalente_3))
             .ForMember(dest => dest.IdConexionEquivalente4, act => act.MapFrom(src => src.conexionequivalente_4))
          ...
          .ForMember(dest => dest.TensionKvTerciario4, act => act.MapFrom(src => src.tensionkvterciario4)).ReverseMap();
            ...
            //_ = CreateMap<InfoCarLocal, SplInfoaparatoCar>().ReverseMap();
             _ = CreateMap<RulesArtifact, SplNormasrep>().ReverseMap();
