namespace SPL.Security.Application.Commands.Security
{
    ...
    public class DeleteAssignmentProfilesUsersCommand : IRequest<ApiResponse<long>>
    {
        public DeleteAssignmentProfilesUsersCommand(AssignmentUsers pData) => this.Data = pData;
        #region Constructor
